namespace WebFeedReader.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebFeedReader.Persistence.PersistenceContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "WebFeedReader.Persistence.PersistenceContext";
        }

        protected override void Seed(WebFeedReader.Persistence.PersistenceContext context)
        {
